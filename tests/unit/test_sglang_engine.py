"""Tests for the SGLang real-cluster engine adapter."""
...
from inferarena.engines.sglang_adapter import SGLangEngine, _prompt_text
...
def test_sglang_engine_run_against_mock() -> None:
    scheduler = FCFSScheduler()
    engine = SGLangEngine(scheduler, EngineSpec())

    spec = ExperimentSpec(
        engine=EngineSpec(name="sglang", model="test-model"),
